...
// 130+ languages supported by the Software Vala enterprise translation engine.
export const languages: Language[] = [
  ...
  { code: "ba", name: "Bashkir", native: "Башҡортса", flag: "🏳️" },
  { code: "cv", name: "Chuvash", native: "Чӑвашла", flag: "🏳️" },
  ...
  { code: "se", name: "Sami", native: "Davvisámegiella", flag: "🏳️" },
  ...
  { code: "lo2", name: "Hmong", native: "Hmoob", flag: "🏳️" },
];
